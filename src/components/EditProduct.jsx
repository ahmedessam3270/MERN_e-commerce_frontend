...
function EditProduct({ onClose, productData, fetchData }) {
  const [componentProductData, setComponentProductData] = useState({
    ...productData,
  ...
  async function handleDeleteProductImage(idx) {
    const newProductImages = [...componentProductData.productImages];
  ...
  async function handleUploadSubmit(e) {
    ...
    const response = await fetch(summaryApi.updateProduct.url, {
      ...
      body: JSON.stringify(componentProductData),
    });
      ...
      <div className="bg-white p-4 rounded w-full max-w-2xl h-full max-h-[80%] overflow-hidden">
        ...
        >
          ...
          <input
            ...
            value={componentProductData.productName}
          ...
          <input
            ...
            value={componentProductData.brandName}
            onChange={handleOnChange}
            className="p-2 bg-slate-100 border rounded"
          />
          ...
          <select
            ...
            required
            onChange={handleOnChange}
            value={componentProductData.category}
            className="p-2 bg-slate-100 border rounded"
          >
            <option value="" hidden>
              Select Category
          ...
          <div>
            {componentProductData?.productImages[0] ? (
              <div className="flex items-center gap-2">
                {componentProductData?.productImages.map((el, idx) => {
                  return (
          ...
          <input
            ...
            value={componentProductData.price}
            onChange={handleOnChange}
            className="p-2 bg-slate-100 border rounded"
          />
          ...
          <input
            ...
            value={componentProductData.sellingPrice}
            onChange={handleOnChange}
            className="p-2 bg-slate-100 border rounded"
          />
          ...
          <textarea
            ...
            onChange={handleOnChange}
            rows={3}
            value={componentProductData.description}
          ></textarea>
